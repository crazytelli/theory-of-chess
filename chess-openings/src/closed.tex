...
\emph{Queen's Gambit Accepted}: \mainline{1. d4 d5 2. c4 dxc4}, main line: \mainline{3. Nf3 Nf6 4. e3 e6 5. Bxc4 c5 6. 0-0 a6} (diagram).\vspace{2mm}
\end{minipage}
\hspace{5mm}
\begin{minipage}[t]{.175\linewidth}
...
\emph{Queen's Gambit Declined}: \mainline{1. d4 d5 2. c4 e6}, main line: \mainline{3. Nc3 Nf6 4. Bg5 Be7 5. Nf3}.\vspace{2mm}
\end{minipage}
\hspace{5mm}
\begin{minipage}[t]{.175\linewidth}
...
\emph{Colle System}: \mainline{1. d4 Nf6 2. Nf3 d5 3. e3 e6 4. Bd3 c5 5. O-O Nc6 6. Re1 Bd6 7. c3 O-O 8. Nbd2} (regardless of how Black defends!).\vspace{2mm}
\end{minipage}
\newline
