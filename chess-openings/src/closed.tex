...
\openingname{Queen's Gambit Declined}: \mainline{1. d4 d5 2. c4 e6}, main line: \mainline{3. Nc3 Nf6 4. Bg5 Be7 5. Nf3}.\vspace{2mm}
\end{minipage}
\hspace{5mm}
\begin{minipage}[t]{.175\linewidth}
...
\openingname{Slav Defense}: \mainline{1. d4 d5 2. c4 c6}, main line: \mainline{3. Nf3 Nf6} (diagram) followed by \mainline{4. e3} or \variation{4. Nc3}.\vspace{2mm}
\end{minipage}
\hspace{5mm}
\begin{minipage}[t]{.175\linewidth}
