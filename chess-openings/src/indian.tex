...
\emph{Benko/Volga Gambit}: \mainline{1. d4 Nf6 2. c4 c5 3. d5 b5}, main line: \mainline{4. cxb5 a6 5. bxa6 Bxa6} (diagram).\vspace{2mm}
\end{minipage}
\hspace{5mm}
\begin{minipage}[t]{.175\linewidth}
...
\emph{Queen's Indian Defence}: \mainline{1. d4 Nf6 2. c4 e6 3. Nf3 b6}, main line: \mainline{4. g3 Ba6} (diagram).
\vspace{2mm}
\end{minipage}
\newline
\begin{minipage}[t]{.175\linewidth}
