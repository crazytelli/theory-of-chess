...
Spanish lines: \emph{Double Spanish} \mainline{4. Bb5 Bb4} (diagram), \emph{Rubinstein} \variation{4...Nd4} or \emph{Classical variation} \variation{4...Bc5}.\begin{center}
\scalebox{0.7}{\showboard}
\end{center}
% \subcaption{...}
\end{framed}
...
\newgame
\emph{Four Knights Game}: \mainline{1. e4 e5 2. Nf3 Nc6 3. Nc3 Nf6}.
\emph{Scotch Four Knights Game}: \mainline{4. d4}, main line: \mainline{4...exd4 5. Nxd4 Bb4 6. Nxc6 bxc6 7. Bd3} (diagram).\begin{center}
\scalebox{0.7}{\showboard}
\end{center}
% \subcaption{...}
\end{framed}
